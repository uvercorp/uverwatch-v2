                                ...
                                <div className="md:min-h-[450px] relative md:px-10">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid gap-6  md:grid-cols-2 ">
                                            ...
                                            <div className="mb-6">
                                                <label htmlFor="title" className="block mb-2 text-sm font-medium my-label">Title</label>
                                                <input type="text" onChange={handleChange} name="title" value={formValue.title} id="title" className=" my-input block p-2.5 w-full " placeholder="Title of post" required />
                                            </div>
                                        </div>

                                        <div className="mb-6">
                                            <label htmlFor="description" className="block mb-2 text-sm font-medium my-label">Describe the post</label>
                                            <textarea id="description" onChange={handleChange} name="description" value={formValue.description} rows="3" class="my-input block p-2.5 w-full " placeholder="Post Description..."></textarea>
