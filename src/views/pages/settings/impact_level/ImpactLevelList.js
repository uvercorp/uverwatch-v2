...
function ImpactLevelList(props) {
    ...
    <>
      ...
      <Card>
        <Card.Header>
          <Card.Title as="h4">
            ...
            <div className="flex items-start justify-between">
              <span>Impact Levels | <span className="text-[0.6em]">List</span> </span>
              <Button variant="warning" onClick={()=>props?.toggleFormType('add','')}>Add Impact Level</Button>
        ...
        <Card.Body >
          ...
          {(!props.pending && props?.impactlevels?.length < 1) &&
    <div className="md:flex items-center justify-center ">
        <div className="bg-white p-5 font-semibold text-[1.5em]">No Results Found</div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              {props?.impactlevels?.map((record, index) => (
...
export default ImpactLevelList;
