                ...
                <Card.Header>
                    <Card.Title as="h4">
                        ...
                        <div className="flex items-start justify-between">
                            <span className="my-font-family-overpass-mono font-semibold text-[#dbdbde]">Impact Level : <span className="text-[0.6em] capitalize"> {props?.formType} </span> </span>
                    ...
                    >
                        ...
                        <div className="md:min-h-[450px] relative">
                            ...
                            <div>
                                ...
                                <div className="mb-4">
                                    <label for="name" className="block mb-2 my-label">ImpactLevel Name</label>
                                    <input type="text" onChange={handleChange} name="name" value={formValue.name} id="name" className=" block w-full my-input" placeholder="Name of Impact Level" required />
                                </div>

                                <div className="mb-4">
                                    <label for="description" className="block mb-2 my-label">Describe the ImpactLevel</label>
                                    <textarea id="description" onChange={handleChange} name="description" value={formValue.description} rows="3" class="block p-2.5 w-full my-input" placeholder="Impact Level Description..."></textarea>
