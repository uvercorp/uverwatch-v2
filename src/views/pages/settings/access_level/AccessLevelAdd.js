                ...
                <Card.Header>
                    <Card.Title as="h4">
                        ...
                        <div className="flex items-start justify-between">
                            <span>Access Level | <span className="text-[0.6em] capitalize"> {props?.formType} </span> </span>
