    ...
    <>
      ...
      <Card>
        <Card.Header>
          <Card.Title as="h4">
            ...
            <div className="flex items-start justify-between">
              <span>Tags | <span className="text-[0.6em]">List</span> </span>
              <Button variant="warning" onClick={()=>props?.toggleFormType('add','')}>Add Tag</Button>
        ...
        <Card.Body >
          ...
          {(!props.pending && props?.tags?.length < 1) &&
