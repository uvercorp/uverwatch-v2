...
const ImageInput = ({ handleImageChange,currentImage }) => {
...
<div className="mt-4 w-full ">
      ...
      <div className="items-center" style={{maxWidth: '100px'}} >
                      {/* <img src={imageUrl} /> */}
                      {/* {selectedImage && (
...
{selectedImage && (
        <img src={selectedImage} alt="Selected Image" width={100} /> // Preview image
      )}
