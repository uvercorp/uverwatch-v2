        ...
        <Card.Header>
          <Card.Title as="h4">
            ...
            <div className="flex items-start justify-between">
              <span>Teams | <span className="text-[0.6em]">List</span> </span>
              <Button variant="warning" onClick={()=>props?.toggleFormType('add','')}>Add Team</Button>
        ...
        <div className="bg-white p-5 font-semibold text-[1.5em]">No Results Found</div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              {props?.teams?.map((record, index) => (
                ...
                <div onClick={()=>props?.searchTeam(record)} className="cursor-pointer">
                <div className="">  <i
