...
function DeploymentStatusList(props) {
    ...
    <>
      ...
      <Card>
        <Card.Header>
          <Card.Title as="h4">
            ...
            <div className="flex items-start justify-between">
              <span> Statuses | <span className="text-[0.6em]">List</span> </span>
        ...
        <Card.Body >
          ...
          {(!props.pending && props?.deploymentstatus?.length < 1) &&
    <div className="md:flex items-center justify-center ">
        <div className="bg-white p-5 font-semibold text-[1.5em]">No Results Found</div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              {props?.deploymentstatus?.map((record, index) => (
