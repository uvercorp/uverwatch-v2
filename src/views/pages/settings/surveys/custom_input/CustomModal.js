...
function CustomModal(props) {
  ...
  return (
    ...
    {(props.customFieldView == 'add' || props.customFieldView == 'update') &&(
     <Add  addCustomField={props.addCustomField} customFieldView={props.customFieldView} setCustomFieldView={props.setCustomFieldView} handleCustomFieldChange={props.handleCustomFieldChange } record={selectedRecord} selectedUpdateRecord={props.selectedUpdateRecord} formType={formType}  />
    )
   }
