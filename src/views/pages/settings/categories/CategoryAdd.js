                ...
                <Card.Header>
                    <Card.Title as="h4">
                        <div className="flex items-start justify-between">
                            <span className="my-font-family-overpass-mono font-semibold text-[#dbdbde]">Categories: <span className="text-[0.6em] capitalize">{props?.formType}</span></span>
                    ...
                    <motion.div initial={{ y: 25, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.75 }}>
                        <div className="md:min-h-[450px] relative">
                            <div className="mb-6">
                                ...
                                <input type="text" name="name" id="name" value={formValue.name} onChange={handleChange} className="my-input block w-full p-2.5" placeholder="Name of Category" required />
                            </div>
                            <div className="mb-6">
                                <label htmlFor="description" className="block mb-2 my-label">Describe the Category</label>
                                <textarea id="description" name="description" rows="3" value={formValue.description} onChange={handleChange} className="block p-2.5 w-full my-input" placeholder="Category Description..."></textarea>
                            </div>
                            {/* Icon Field */}
                            ...
                            <div className="mb-6">
                                <label htmlFor="parent_id" className="block mb-2 my-label">Parent Category (optional)</label>
