...
function SingleIncomingListCard(props) {
  ...
  return (
    ...
    DATE: {new Date(props?.post?.created_at).toLocaleDateString('en-GB', {
      ...
      year: '2-digit'
        ...
        <div className="text-sm cursor-pointer text-white hover:underline " onClick={() => { props?.setSelectedRecord(props?.post); props.setShow(true); }}>Update Report</div>
...
export default SingleIncomingListCard;