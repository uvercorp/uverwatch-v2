...
import SinglePostListCard from "./SingleIncomingListCard";
import IncomingList from "./IncomingList";
import FilterTopNav from "../data_view/FilterTopNav";
import PostSearch from "../data_view/PostSearch";
import LocationSearch from "../data_view/LocationSearch";
import AutocompleteLocationSearch from "../data_view/AutocompleteLocationSearch";
...
import MapView from "../data_view/MapView";
...
function IncomingPage() {
 ...
 function capitalizeFirstLetter(string) {
  ...
  const getPostData = async (deployment_id) => {
    try {
      setPending(true);
      const response = await axiosInstance.get("getPostDataWhatsapp/" + deployment_id, {
        headers: {
  ...
  selectedStatuses.includes(post.post_status);
  ...
  const uniqueStatuses = [...new Set(
    posts.flatMap(post => [post.status, post.post_status])
  )];
