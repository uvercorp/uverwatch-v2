            ...
            >
              ...
              {currentUser !== "" &&
                ...
                parseInt(props?.post?.created_by) === parseInt(currentUser) && (
                  <>
                    <button className="block w-full text-left px-3 py-2 hover:bg-gray-700">
                    <div className="flex items-start gap-2" onClick={() => { props.setSelectedRecord(props?.post); props?.handleAssignPost(props?.post); }}>
                    <i className="far fa-user"></i> <span>Assign</span></div>
                    </button>
                    <button className="block w-full text-left px-3 py-2 hover:bg-gray-700">
                    <div className="flex items-start gap-2" onClick={() => {props.setSelectedRecord(props?.post); props?.handleLinkPost(props?.post); }}>
                            <i className="fas fa-exchange-alt"></i>
                            <span>Link</span></div>
                    </button>
                    <button className="block w-full text-left px-3 py-2 hover:bg-gray-700">
                    <div className="flex items-start gap-2"  onClick={() => { props?.setSelectedRecord(props?.post); props.setShow(true); }}>
