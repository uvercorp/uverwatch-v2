      ...
      <div className="flex items-start justify-between ">
        ...
        <div className="flex justify-end gap-6 px-2">
          ...
          {localStorage.getItem('is_login') == 'yes' && (<>
            ...
            <span style={{ height: "30px", width: "30px" }} className="cursor-pointer p-1" onClick={() => { props?.setSelectedRecord(props?.post); props.handleSharePost(); }}>
      ...
      <div className="flex justify-start gap-6">
        ...
        <div className="grid grid-cols-1">
          ...
          <div className="flex justify-start gap-6 text-sm text-gray-500">
            ...
            <div>via web</div>
            <div>By <span className="italic text[0.3em]">{props?.post?.created_by_name}</span></div>
