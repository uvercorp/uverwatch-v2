        ...
        <>
          ...
          <div className='grid grid-cols-1 md:grid-cols-1 gap-5 p-4 '>
            <div>
              ...
              <div className="flex px-4 my-label  py-1 rounded-xl items-center justify-between italic mt-0 mb-2">
                <span>
                  <b>Deployment Name : </b>
                  {/* <br /> */}
                  <span className="ml-2">{props.formValue.name}</span>
                </span>
              </div>

              <div className="flex px-4 my-label  py-1 rounded-xl items-center justify-between italic">
                <span>
                  <b>Deployment URL : </b>
                  {/* <br /> */}
              ...
              <div className="flex px-4 my-label  py-1 rounded-xl items-center justify-between italic mb-2">
                <span>
